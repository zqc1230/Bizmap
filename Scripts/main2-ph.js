...
//}
$("#cpright").html(' Copyright © 2012, Bizmap.ca, Beta 1.013-y');
...
//var isclicknum = true;    
var conText;
conText = "<strong>What is <a href='http://bizmap.ca/' target='_blank'>bizmap.ca</a></strong><br>Bizmap.ca is a free web based application to help people finding exactly business and service locations. It works on iPhones.";
conText += "<br>It's not a simple business directory. It's totally reconstructed to fit mobile internet use. ";
conText += "<br><strong>Why <a href='http://bizmap.ca/' target='_blank'>bizmap.ca</a></strong>";
...
conText += "<br><strong>Even more.</strong>";
...
$(document).ready(function () {
    ...
    $("#cpright").live('click', function () {
        $("#about").html("<div id='copyrightCanvas'><div id='copyrightText'></div></div><div id='closesaved1' onclick='closeabout()'><span class='chahao'>×</span></div><div id='closesaved' onclick='closeabout()'><span class='chahao'>×</span></div>");
...
function click_map(x) {
    ...
    if (!hisw && !mapEve) {
        ...
        $("#page0,#page1").attr("class", 'pylfet1');
        //setTimeout('$("#page0,#page1").attr("class", "pylfet1")',400);
        ...
        if (editSwitch == "") {
            ...
            if (keywords == "none") {
                ...
                $("#list").html("<center><br><br><br><br><div id=\"backonList\" style='margin-left:118px' onclick=\"click_back()\">Main page</div><div onclick=\"dis(event);newReport(2);\" id=\"list-re\">Write something to us.</div></center>");
                //$("#backonList").css('margin-left', '118px');
                /*$("#list-re").click(function () {
                inputSwitch = true; newReport(2);
                // setTimeout("inputSwitch=true;newReport(2)", 1000);
                });*/
            }
...
function click_back() {
    //debugger;
    $("#page0,#page1").attr("class", 'pyright1');
    //setTimeout('$("#page0,#page1").attr("class", "pyright1")', 400);
...
function changeBorder(id) {
    ...
    if (curb < max && curt) {
        ...
        /*  curb = parseFloat(curb) + 0.01;
        $("#" + id).css('-webkit-transform', 'scale(0.1)');*/
    }
    else {
        curb = parseFloat(curb) - 0.005;
        curt = false;
                ...
                try {
                    ...
                    if (a) {
                        ...
                        for (var i = 0; i < ticketnum; i++) {
                            if (i < 30) {//防止出错 onclick='gettickets(this)'
                                li += "<li>" + a[8 + i] + "</li>"; //id='li" + i + "'
                            }
                        }
                        //$("#monthpspan").html(100);
                        //$("#totalpspan").html(123);
