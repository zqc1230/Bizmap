...
//}
$("#cpright").html(' Copyright © 2012, Bizmap.ca, Beta 1.013');
...
function listMenu(arrList) {
    ...
    try {
        for (j = 1; j < arrList.length; j++) {
            ...
            menuList += "<div class='listMain2' onclick=\"gmbc(0,this);dis(event);clickSearchs('" + ppmenu + "');\">&nbsp;" + arrSubList[0] + "</div>"; //主菜单+点击事件[dis(event);clickSearchs('" + pmenu + "');]
            menuList += "</div>"; //展开菜单结束
            ...
            for (i = 1; i <= arrSubList.length - 1; i++) {
                ...
                menuList += "<div id='" + j + i + "' class='listSub' onclick=\"gmbc(1,this);clickSearchs('" + smenu + "')\"><a>" + smenu1 + "</a></div>";
...
function addDiv(v, vj) {
    ...
    if (newInput.toUpperCase() == "NONE01") {
        ...
        if (newInput.length <= 1) {
            ...
            newContent = newContent + "<div class='listMain2' onclick=\"dis(event);gmbc(0,this);clickSearchs('" + strInput + "');\">&nbsp;" + newInput + "</div>";
            ...
            var sdv1HTML = "<div id='" + vj + i + "' class='listSub' style='display:block;float:left' onclick=\"gmbc(1,this);clickSearchs('" + strInput + "')\"><a>" + newInput + "</a></div>"
...
function saveSearch(uaid, name, addr, uph, ccode, isshow, sos, scode) {
    ...
    */
    ...
    if (!isshow) {
        ...
        //name = ReplaceF(name);
        $("#page3_detail").html('<div id="Lsd">Location saved.</div><div id="shareit" onclick="shareBiz(true, \'' + uaid + '\', \'' + name + '\',\'' + addr + '\', \'' + uph + '\', \'' + ccode + '\')">Share it</div><br><div id="backonList" onclick="click_back()">Main page</div><div id="closeDetails" onclick="closeDetails();"><span class="chahao">×</span></div>'); //<div id="closeDetails1" onclick="closeDetails();"><span class="chahao">× </span></div>
        $("#page3_details").show();
        $("#closeDetails").css("margin", "9px 25px");
    } else {
        if (sos) {//true:share
            $("#page3_detail").html('<div id="Lsd">Location shared.</div><br><br><div id="closeDetails1" onclick="closeDetails();"><span class="chahao">×</span></div><div id="backonList" onclick="click_back()">Main page</div><div id="closeDetails" onclick="closeDetails();"><span class="chahao">×</span></div>');
        }
        else {//false: saved
            $("#page3_detail").html('<div id="Lsd">Location saved.</div><br><br><div id="closeDetails1" onclick="closeDetails();"><span class="chahao">×</span></div><div id="backonList" onclick="click_back()">Main page</div><div id="closeDetails" onclick="closeDetails();"><span class="chahao">×</span></div>');
    ...
    if (kw != "") {
        ...
        sia = $.ajax({
            ...
            error: function (a) {
                ...
                if (searchSec < 20) {
                    if (kw == "dic$") {
                        resu = "<p id='stcs_result1'>&nbsp;Sorry, no location found <br/><br></p><div style='margin-top: -25px;'><div id=\"list-mp\">Main Page</div><div id=\"list-re\">Write something to us.</div></div>";
                    }
                    else {
                        //resu = "<p id='stcs_result1'>&nbsp;Sorry, no location found for <br/>&nbsp;'" + kw + "' <br></p><div style='margin-top: -25px;'><div id=\"list-mp\">Main Page</div><div id=\"list-re\">Write something to us.</div></div>";
                    }
                    // resu = "<p id='stcs_result1'>&nbsp;Sorry, no location found for <br/>&nbsp;'" + kw + "' <br></p><div style='margin-top: -25px;'><div id=\"list-mp\">Main Page</div><div id=\"list-re\">Write something to us.</div></div>";
                }
                else {
                    resu = "<p id='stcs_result1'>&nbsp;Sorry network slow, please try again later. <br/></p><div style='margin-top: -25px;'><div id=\"list-mp\">Main Page</div><div id=\"list-re\">Write something to us.</div></div>";
                }
                $("#list").html(resu);
            }
        });
...
function StopSearch(tsia) {
    if (isSearching) {
        ...
        $("#cover").hide();
        var listresu = "<p id='stcs_result1'>&nbsp;Sorry network slow, please try again later. <br/><br></p><div style='margin-top: -25px;'><div id=\"list-mp\">Main Page</div><div id=\"list-re\">Write something to us.</div></div>";
        /* if (keywords == "dic$") {
        resu = "<p id='stcs_result1'>&nbsp;Sorry network slow, please try again later. <br/><br></p><div><div id=\"list-mp\">Main Page</div><div id=\"list-re\">Write something to us.</div></div>";
        }
        else {
        resu = "<p id='stcs_result1'>&nbsp;Sorry, no location found for <br/>&nbsp;'" + keywords + "' <br></p><div><div id=\"list-mp\">Main Page</div><div id=\"list-re\">Write something to us.</div></div>";
        }*/
        $("#list").html(listresu);
        isSearching = false;
    }
...
sia.abort();
var resu = "<p id='stcs_result1'>&nbsp;Sorry, no location found for <br/>&nbsp;'" + kw + "' <br></p><div><div id=\"list-mp\">Main Page</div></div>";
$("#list").html(resu);
}
}*/
//#endregion
...
var isAlert = false; //是否已经提醒【不在范围内，只提醒一次，重新定位后刷新】false没提醒
...
$(document).ready(function () {
    ...
    $("#cpright").live('click', function () {
        //debugger;
        $("#saved").html("<div id='copyrightCanvas'><div id='copyrightText'></div></div><div id='closesaved1' onclick='closesaved()'><span class='chahao'>×</span></div><div id='closesaved' onclick='closesaved()'><span class='chahao'>×</span></div>");
        var conText = "<strong>What is <a href='http://bizmap.ca/' target='_blank'>bizmap.ca</a>?</strong><br>Bizmap.ca is a web based application to help people finding exactly ";
        conText += "business and service locations. It works on iPhones and it's totally free.It not a simple business directory.";
        conText += "It's totally reconstructed to fit mobile internet use.<br><br><strong>Why <a href='http://bizmap.ca/' target='_blank'>bizmap.ca</a>?</strong><br>So far, finding businesses is ";
        conText += "still very inconvenient. Many Apps are trying to help you, but also mislead you.'wrong businesses',";
        conText += "'many missings', 'wrong or inaccurate coordinates', 'poor category structures'. Also you almost can not ";
        conText += "search businesses by what they are and what they serve, because of keywords limits.<br>Bizmap.ca devotes ";
        conText += "to build totally new solutions to solve these problems.<br>Bizmap.ca brings you to the font door of business ";
        conText += "or service exactly what you're looking for.<br><br>We think what people's think. We are working on a brand new";
        conText += "database and try very hard to find business's type, major products or services they provide.<br><br>In Bizmap.ca you may find";
        conText += "'key cut', 'oil change', 'ice cream', etc. which other Apps just can find them by vendor's names.You may find an 'ATM' or ";
        conText += "'Coffee' is very closed  to you and are able to walk to. We know who has the ATM and who service you coffee. Other Apps ";
        conText += "simply send you to the banks or coffee shops far away.<br><br>You can find locations which is even not a business. ";
        conText += "Everybody knows where is 'Eaton Centre', but what about a friend invite you to 'Jubilee Square' or 'woodbine shopping centre'? ";
        conText += "You will find only Bizmap.ca helps you.<br><br>Bizmap.ca is web-based. Any time any iPhone users can use it in browser. No App download, ";
        conText += "no account needed.<br><br>We make location sharing never so easy. System will generate a simple URL address which you can send to friends by email,";
        conText += "text message or twitter. What your friends need to do is just click the link. Bizmap.ca will show them the exact point on map. Then nobody ";
        conText += "bother you with the direction questions.<br><br><strong>Even more.</strong><br>We need your help to make this idea works well. We count points to you while you report business";
        conText += "informations and invite more members. You will have chances to win iPhones monthly or get points redeemed by business coupons in the future. ";
    ...
    $("#Previouswin").live('click', function () {
        // $("#account").html('<div id="winners"></div><div id="winners"></div>');
    });
    testaccount();
    //#region 关闭提示框
    ...
    //            else {
    //                if (userLevel < 3) {
    //                    var tacc = '<div id="a2" onclick="a2()">Previous reports</div><div id="a4" onclick="a4()">Invite friends</div><div id="a41"></div><div id="a1" onclick="a1()">Change Passwords</div><div id="closeDetailsaccount" onclick="closeaccount();"><span class="chahao">×</span></div>';
    //                    $("#account").html(tacc);
    //                    $("#account").show();
    //                }
    //                else {
    ...
    try {
        ...
        if ($("#Report").html() == "Next") {
            ...
            if (reportinfo != "") {
                ...
                $("#Report, #CloseReport").css("margin-top", "-5px");
                $("#tools").css("top", "255px");
                //#region
                $("#tools").height(45);
                $("#tool,#tools").show();
...
function reportToDB(x) {
    try {
        ...
        //tmsg = $("#dmsg").html();
        // $("#dmsg").html('<center><br><br><br>Report Data Updating ……</center>');
        $("#dmsg").html('<center><br><br><br>Submiting Thanks!</center>');
        //$("#dmsg").html('<center><br><br><br>Submit save, Thanks!</center>');
        var gatt = 'f';
        if (gpsAtt) {
            gatt = 't';
        }
    ...
    $.ajax({
        ...
        success: function (info) {
            ...
            if (info != "true" && x != '1') {
                ...
                //$("#dmsg").html('<div id="divArea" style="border: 0px;"></div><span id="CloseReport" onclick="CloseReport(' + x + ')"><span class="chahao">×</span></span> <span id="Report" onclick="Next(\'' + x + '\')">Next</span><div style="height:10px;clear: both;"></div>');
                //                $("#divArea").html("<center style='color: gray;'><br>This location may not covered by bizmap.ca<center>");
                ...
                /*if (isInrange == false && isAlert == false && x != 2) {//如果不在范围内且没有提示
                isAlert = true;
                alert('Your area may not be covered by Bizmap.ca');
                }*/
            }
...
function showPr() {
    ...
    var tacc = '<div id="a21">Previous reports</div><div id="pr"><div id="pr1"><center><br><br><br><br><br>Reports Data Loading ……<center></div></div><div id="closeDetailspr" onclick="backToaccount();"><span class="chahao">×</span></div>';
    $("#account").html(tacc);
    var who;
    if (storage.getItem("account") != null && storage.getItem("account") != "") {
        who = storage.getItem("account");
...
function a3() { //Comments[<div id="com"><div id="com1">]
    ...
    var tacc = '<div id="a21">Comments</div><div id="subcom"><input onfocus="inputfocus(1)" id="incom" type="text" class="txt" title="Please input Comments" /><span id="subcomments" onclick="subcomments()">Submit</span></div><div id="com"><div id="com1"><center><br><br><br><br>Comments Data Loading ……<center></div></div><div id="closeDetailspr" onclick="backToaccount();"><span class="chahao">×</span></div>';
    $("#account").html(tacc);
    $('#com1').touchScroll();
    ajaxcomm();
}
function a4() {
    if ($("#a41").is(":visible")) {
        ...
        $("#a41").hide();
        $("#closeDetailsaccount").css({ marginTop: "98px" });
        clearTimeout(tif);
        notif = true;
    }
    else {
        ...
        $("#a41").html('<input id="inif" onfocus="testif()" onblur="setTimeout(\'toTop()\', 500);" type="email" class="txt" title="Please input Invite friend\'s Email" /><br><span id="subif" onclick="subif()">Submit</span>');
        $("#a41").show();
        $("#inif").focus();
    ...
    //    var tacc = '<div id="a21">Invite friends</div><div id="if"><input onfocus="inputfocus(1)" id="inif" type="text" class="txt" title="Please input Invite friend\'s Email" /><span id="subcomments" onclick="subcomments()">Submit</span></div><div id="com"><div id="com1"><center><br><br><br><br>Comments Data Loading ……<br><br><img src=\"images/loading/loading11.gif\" /><center></div></div><div id="closeDetailspr" onclick="backToaccount();"><span class="chahao">×</span></div>';
    //    $("#account").html(tacc);
    //    $('#com1').touchScroll();
    //    ajaxcomm();
}
...
function backToaccount() {
    try {
        if (userLevel < 3) {
            //var tacc = '<div id="a2" onclick="showPr()">Previous reports</div><div id="a4" onclick="a4()">Invite friends</div><div id="a41"></div><div id="a1" onclick="a1()">Change Passwords</div><div id="closeDetailsaccount" onclick="closeaccount();"><span class="chahao">×</span></div>';
            var tacc1 = '<div id="a2" onclick="showPr()">Previous reports</div><div id="a4" onclick="a4()">Invite friends</div><div id="a41"></div><div id="a1" onclick="a1()">Change Passwords</div><div id="a5" onclick="a5()">Points:<span id="ponum"></span></div><div id="closeDetailsaccount" onclick="closeaccount();"><span class="chahao">×</span></div><div id="closeDetailsaccount1" onclick="closeaccount();"><span class="chahao">×</span></div>';
            $("#account").html(tacc1); //tacc1
            $("#account").show();
            $("#closeDetailsaccount").css({ marginTop: "37px" });
        }
        else {
    ...
    //var tacc = '<div id="a1" onclick="a1()">Manage account</div><div id="a2" onclick="showPr()">Previous reports</div><div id="a3" onclick="a3()">Comments</div><div id="a4" onclick="a4()">Invite friends</div><div id="a41"></div><div id="closeDetailsaccount" onclick="closeaccount();"><span class="chahao">×</span></div>';
    //$("#account").html(tacc);
}
//提交评论
...
function showsaved() {
    // // debugger;;
    $("#saved").html('<div id="savedinfo"></div><div id="closesaved1" onclick="closesaved()"><span class="chahao">×</span></div><div id="closesaved" onclick="closesaved()"><span class="chahao">×</span></div>');
    //showsavedinfo
    //    var bm2 = bm1.split("|");
...
function closesaved() {
    ...
    $("#saved").html('<div id="showsaved">Saved</div><div id="showshared">Shared</div><div id="showaccount">Account</div>');
...
function showshared() {
    $("#saved").html('<div id="savedinfo"></div><div id="closesaved1" onclick="closesaved()"><span class="chahao">×</span></div><div id="closesaved" onclick="closesaved()"><span class="chahao">×</span></div><div id="ra">Remove all</div>');
...
function saveCurLocation(gpsLL, tgpsll) {
    ...
    if (!savedexist) {
        $("#c").html("Location <a style='font-weight: bolder;color:blue;font-size: small;'>" + tgpsll + "</a><br>  was saved.<br><br><div id=\"backonList\" onclick=\"click_back()\">Main page</div>"); //<br><br><div class='cross1' onclick='closeCurLocation()'>Close</div>
    }
    else {
        $("#c").html("Location <a style='font-weight: bolder;color:blue;font-size: small;'>" + tgpsll + "</a><br> was already saved.<br><br><div id=\"backonList\" onclick=\"click_back()\">Main page</div>"); //<br><br><div class='cross1' onclick='closeCurLocation()'>Close</div>
    }
    //$("#c").html("Location <a style='font-weight: bolder;color:blue;font-size: small;'>" + url + "</a> was saved.<br>Search in bizmap.ca by the code:<a style='font-weight: bolder;color:blue;font-size: small;'>" + scode + "</a>,<br>or enter the link above in browser to find<br>this location.<br><div class='cross1' onclick='closeCurLocation()'>Close</div>");
    //}
    ...
    if (!hisw && !mapEve) {
        ...
        if (editSwitch == "") {
            ...
            if (keywords == "none") {
                ...
                $("#list").html("<center><br><br><br><br><div id=\"backonList\" style='margin-left:118px' onclick=\"click_back()\">Main page</div><div onclick=\"dis(event);newReport(2);\" id=\"list-re\">Write something to us.</div></center>");
...
function backmap(x) {
    ...
    if (!clickSearching && hisw) {
        if (!(infoinmappage && infoinmappage.indexOf("table") != -1)) {
            //alert(3532);
            infoinmappage = "<center><br><br><br><br><div id=\"backonList\" style='margin-left:118px' onclick=\"click_back()\">Main page</div><div onclick=\"dis(event);newReport(2);\" id=\"list-re\">Write something to us.</div></center>";
        }
        try {
...
function zoomClick(n, t, type) {
    ...
    if (n == 1) {//放大
        ...
        if (map.getZoom() > 17 && map.getMapTypeId() == 'roadmap' && type == '1') {
            //map.setZoom(map.getZoom() + 1);
...
LatLngControl.prototype.updatePosition = function () {
...
function initialize(param) {
    ...
    //            map.controls[google.maps.ControlPosition.BOTTOM_LEFT].push(bottomControlDiv);
    //---------------------------------------------------------------------------------------------
...
function centerControl(centerControlDiv, map) {
    var tUI = document.createElement('div');
    var hei = $("#map_canvas").height() / 2;
    tUI.style.width = '29px'; //24
    tUI.style.height = '31px'; //24
    tUI.style.opacity = '0';
    tUI.style.border = '0px';
    //tUI.style.marginTop = '103px';
    tUI.style.background = 'url(images/cross1.PNG)';
    tUI.style.cursor = 'pointer';
    tUI.id = 'centerMap';
...
//            tUI.id = 'nearby';
//            tUI.style.border = '0px';
//            tUI.style.background = 'url(images/bg_nearby65-30.png)';
...
function BottomControl(bottomDiv, map) {
    var rUI = document.createElement('Span');
    rUI.style.width = '100px';
    rUI.style.height = '20px';
    //rUI.style.opacity = '0.8';
    rUI.style.textAlign = 'middle';
    // bottomDiv.appendChild(rUI);
    //$("#tools").appendChild(rUI);

    var typeText11 = document.createElement('value');
    typeText11.style.fontFamily = 'Arial,sans-serif';
    typeText11.style.marginLeft = '5px';
    //   typeText11.style.border = '1px solid';
    typeText11.style.color = 'darkblue';
    typeText11.style.fontSize = '10px';
    typeText11.innerHTML = 'Reload map';
    rUI.appendChild(typeText11);
...
function tocross() {
    ...
    cross();
    //cb = setInterval('changeBorder("centerMap", 0, 16);', 100);
...
function getback() {
    ...
    try {
        ...
        setTimeout('$("#tools").height(0);$("#tool,#tools").hide();', 1);
        bhi = true;
        $('#list').touchScroll('setPosition', (parseInt(scrollY) + 45));
    } catch (e) { catche(e); }
...
function a5() {
    try {
        ...
        */
        //==
        //== T2
        pointdiv += '<div id="pim"><div id="pimg">Activities:<br/>Sharing:<br/>Reports:<br/>Inviting:<br/>Bonus:</div>';
        ...
        pointdiv += '</div>';
        //==
        pointdiv += '<br/><span id="monthtspan" class="points">This month tickets</span><br/><div id="monthtdiv"><div id="monthtdiv1"><br><center>loading ……</center></div></div>';
        pointdiv += '<div id="Previouswin">Previous winners</div>';
        pointdiv += '<div id="closepoints" onclick="backToaccount();"><span class="chahao">×</span></div><div id="closepoints1" onclick="backToaccount();"><span class="chahao">×</span></div>';
        ...
        $.ajax({
            ...
            success: function (a) {
                try {
                    //debugger;
                    if (a) {
                        //a = "3;3;1;1;1;2;1;8;#38616804;#44577760;#05822172;#03286363;#18240208;#20474652;#70145631;#13035161;"
                        a = a.split(";");
                        //本月积分
                        var count = 0;
                        ...
                        var length1 = parseInt((a[2] / pointMax1) * 100) + "%"
                        var length2 = parseInt((a[3] / pointMax1) * 100) + "%"
                        var length3 = parseInt((a[4] / pointMax1) * 100) + "%"
                        var length4 = parseInt((a[5] / pointMax1) * 100) + "%"
                        var length5 = parseInt((a[6] / pointMax1) * 100) + "%"
                        //debugger;
                        for (var i = 1; i < 6; i++) {
                        ...
                        //如果用户积分10000以上，则向左移一点
                        if (a[1] >= 10000) {
                            $("#totalpdiv").css('margin-left', '13px');
                        }
                        var ticketnum = 0;
                        if (a[7]) {
                            ticketnum = a[7];
                        ...
                        for (var i = 0; i < ticketnum; i++) {
                            if (i < 30) {//防止出错
                                li += "<li onclick='gettickets(this)'>" + a[8 + i] + "</li>"; //id='li" + i + "'
                            }
                        }
                        //$("#monthpspan").html(100);
                        //$("#totalpspan").html(123);
                        ...
                        if (ticketnum > 0) {
                            ...
                            $("#monthtdiv1").html('<center>' + lackT + '</center>');
                        }
                        if (ticketnum < 4) {
                            $("#monthtdiv,#monthtdiv1").height(34);
                            $("#closepoints").css('margin-top', '98px');
                            $("#closepoints1").css('margin-top', '98px');
                        }
                        else {
                            $("#monthtdiv").height(65);
...
function click_details(a, b, c, d, e, f, g, h, i, j, k, plat, plng, ccode, th, exii, dis, scode) {
    //a:aid
    //b:name
    //c:address
    //d:phone
    ...
    //#region 如果是普通搜索
        ...
        var details = '<table id="p3_top" style="border: 0px;"><tr><td style="vertical-align: top;width: 210px;"><table id="p3_bizinfo"><tr><td style="border-bottom: 1px solid orange;" colspan="2"><table cellpadding="0" cellspacing="0"><tr onclick="centerwithGPS(\'' + plat + '\',\'' + plng + '\',\'' + k + '\',\'\',\'\',\'\',\'\',\'\',\'\',true,0,true,\'1\')"><td style="width: 27px;"><div class="bizListIcon" style="background-image: url(\'./images/Icon_b_none.png\');">' + k + '</div></td><td id="biz_name" class="details"></td></tr></table></td></tr><tr><td id="biz_info" class="details" colspan="2"></td></tr><tr><td id="biz_address" class="details"></td><td rowspan="3"><table id="bizpic" cellpadding="0" cellspacing="0"><tr><td id="imgbiz"></td></tr><tr><td><div id="biz_hours"></div></td></tr></table></td></tr><tr><td id="biz_phone" class="details"></td></tr><tr><td id="biz_Fax" class="details"></td></tr><tr><td id="biz_Email" class="details"></td></tr><tr><td id="biz_Website" class="details"></td></tr></table></td></tr></table>';
        var fun;
        //if (storage.getItem("account") != null && storage.getItem("account") != "") {
    ...
    //#region Saved
        ...
        $("#page3_detail").html('<table id="p3_top" style="border: 0px;"><tr><td style="vertical-align: top;width: 210px;"><table id="p3_bizinfo"><tr><td style="border-bottom: 1px solid orange;" colspan="2"><table cellpadding="0" cellspacing="0"><tr onclick="centerwithGPS(\'' + plat + '\',\'' + plng + '\',\'' + 1 + '\',\'\',\'\',\'\',\'\',\'\',true,1,true)"><td style="width: 27px;"><div class="bizListIcon" style="background-image: url(\'./images/Icon_b_none.png\');">' + 1 + '</div></td><td id="biz_name" class="details"></td></tr></table></td></tr><tr><td id="biz_info" class="details" colspan="2"></td></tr><tr><td id="biz_address" class="details"></td><td rowspan="3"><table id="bizpic" cellpadding="0" cellspacing="0"><tr><td id="imgbiz"></td></tr><tr><td><div id="biz_hours"></div></td></tr></table></td></tr><tr><td id="biz_phone" class="details"></td></tr><tr><td id="biz_Fax" class="details"></td></tr><tr><td id="biz_Email" class="details"></td></tr><tr><td id="biz_Website" class="details"></td></tr></table></td></tr></table><div id="p3_ownernotes"><div class="cross4" onclick="shareBiz(false,\'' + a + '\',\'' + tb + '\',\'' + c + '\',\'' + d + '\',\'' + ccode + '\')" id="shareBiz">Share</div><div class="cross5" style="color: gray;" id="saveBiz">Save</div><div id="closeDetails" onclick="closeDetails();"><span class="chahao">×</span></div></div>');
        //<td id="imgbiz"> <img src="" id="imgbiz0" onclick="javascript:showBizImg(1);" name="imgbiz0" onerror=\'imgError1(this.id)\' alt="" />
    ...
    if ((b.indexOf("Shared Location:") == -1) && (b.indexOf("Saved Location:") == -1)) {
        //如果有账户或特权，可进
        $(".cross4").css('margin-left', '21px');
        $(".cross5").css('margin-left', '100px');
    }
    $("#biz_name").html(b);
...
function closep1() {
    $("#page3_details").css("background-color", "#d7d8d9");
    $("#page3_detail").html('<div id="Lsd">Shared location saved.</div><br><br><div id="closeDetails1" onclick="closeDetails();"><span class="chahao">×</span></div><div id="backonList" onclick="click_back()">Main page</div><div id="closeDetails2" onclick="closeDetails();"><span class="chahao">×</span></div>');
    $("#backonList").css("margin-left", "74px");
}
